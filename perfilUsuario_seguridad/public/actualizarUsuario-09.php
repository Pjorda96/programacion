...
<html>
  ...
  <body>
    ...
    <form name="enviar" method="post" action="listadoUsuarios-09.php" onsubmit="return js/actualizarBlanco()">
      <fieldset>
        <?php
        $baseDatos->leerDatos();
        ?>
    ...
    <button type="button" name="button" onclick="location.href='listadoUsuarios-09.php'">Volver</button>
